...
class QuicFFIBindings {
  ...
  int dart_quic_client_new_async(
    ffi.Pointer<QuicExecutor> executor,
    ffi.Pointer<QuicFfiClientConfig> config,
    UsizeCallback callback,
  ) {
    return _dart_quic_client_new_async(executor, config, callback);
  }

  late final _dart_quic_client_new_asyncPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Int32 Function(
            ffi.Pointer<QuicExecutor>,
        ...
        >
      >('dart_quic_client_new_async');
  late final _dart_quic_client_new_async = _dart_quic_client_new_asyncPtr
      .asFunction<
        int Function(
          ffi.Pointer<QuicExecutor>,
          ffi.Pointer<QuicFfiClientConfig>,
